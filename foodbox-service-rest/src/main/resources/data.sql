...
insert into menu(id,name,description,category,imgurl,price) values (5,'Spicy Brocoli','A description of Spicy Brocoli.','chinese','assets/img/chinese/chinese_spicybrocoli.jpeg',14.49);
insert into menu(id,name,description,category,imgurl,price) values (6,'Beef Brocoli','A description of Beef Brocoli.','chinese','assets/img/chinese/chinese_beefbrocoli.jpeg',11.19);

insert into menu(id,name,description,category,imgurl,price) values (7,'Biryani','A description of Biryani.','indian','assets/img/indian/indian_biryani.jpeg',14.49);
